...
- Next.js frontend now includes login/register, session status, a home search workspace, a menus dashboard with inline course/item editors plus a search/ingest drawer, a Library + Log hub for status tracking and timeline entries, and slug-based public menu pages rendered at `/menus/[slug]`.
